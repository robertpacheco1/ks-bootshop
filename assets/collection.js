...
const loadCollection = async () => {
  ...
  document
    .querySelector("#offcanvas-filters .offcanvas-footer")
    ?.replaceWith(
      newDocument.querySelector("#offcanvas-filters .offcanvas-footer")
    );

  document
    .querySelector("#offcanvas-filters .btn-filters-clear-all")
    ?.replaceWith(
      newDocument.querySelector("#offcanvas-filters .btn-filters-clear-all")
    );

  document
    .querySelector('#offcanvas-filters [name="sort_by"]')
    ?.replaceWith(
      newDocument.querySelector('#offcanvas-filters [name="sort_by"]')
    );
